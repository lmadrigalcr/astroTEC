...
-- Schema astroDB
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `astroDB` DEFAULT CHARACTER SET utf8 ;
USE `astroDB` ;
...
CREATE TABLE IF NOT EXISTS `astroDB`.`Usuarios` (
  ...
  INDEX `FK_idTipoUsuarioXTipoUsuario` (`fk_idTipoUsuario` ASC),
...
CREATE TABLE IF NOT EXISTS `astroDB`.`Eventos` (
  ...
  `fk_idGaleria` INT NULL DEFAULT NULL,
  `fk_idEstado` INT NOT NULL,
